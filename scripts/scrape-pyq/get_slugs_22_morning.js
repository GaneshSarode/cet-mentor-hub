...
async function getSlugs() {
  const url = 'https://questions.examside.com/past-years/year-wise/jee/mht-cet/mht-cet-2025-22nd-april-morning-shift';
  ...
  const shiftPath = '/past-years/year-wise/jee/mht-cet/mht-cet-2025-22nd-april-morning-shift/';
  ...
  fs.writeFileSync('slugs_22_morning.json', JSON.stringify(subjects, null, 2));
}
getSlugs();

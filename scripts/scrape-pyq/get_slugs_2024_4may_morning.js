...
async function getSlugs() {
  const url = 'https://questions.examside.com/past-years/year-wise/jee/mht-cet/mht-cet-2024-4th-may-morning-shift';
  ...
  const shiftPath = '/past-years/year-wise/jee/mht-cet/mht-cet-2024-4th-may-morning-shift/';
  ...
  fs.writeFileSync('slugs_2024_4may_morning.json', JSON.stringify(subjects, null, 2));
}
getSlugs();

...
async function getSlugs() {
  const url = 'https://questions.examside.com/past-years/year-wise/jee/mht-cet/mht-cet-2025-20th-april-morning-shift';
  ...
  const shiftPath = '/past-years/year-wise/jee/mht-cet/mht-cet-2025-20th-april-morning-shift/';
  ...
  fs.writeFileSync('slugs_20_morning.json', JSON.stringify(subjects, null, 2));
}
getSlugs();

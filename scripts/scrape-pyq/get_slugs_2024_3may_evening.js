...
async function getSlugs() {
  const url = 'https://questions.examside.com/past-years/year-wise/jee/mht-cet/mht-cet-2024-3rd-may-evening-shift';
  ...
  const shiftPath = '/past-years/year-wise/jee/mht-cet/mht-cet-2024-3rd-may-evening-shift/';
  ...
  fs.writeFileSync('slugs_2024_3may_evening.json', JSON.stringify(subjects, null, 2));
}
getSlugs();

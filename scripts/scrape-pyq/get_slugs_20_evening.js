...
async function getSlugs() {
  const url = 'https://questions.examside.com/past-years/year-wise/jee/mht-cet/mht-cet-2025-20th-april-evening-shift';
  ...
  const shiftPath = '/past-years/year-wise/jee/mht-cet/mht-cet-2025-20th-april-evening-shift/';
  ...
  fs.writeFileSync('slugs_20_evening.json', JSON.stringify(subjects, null, 2));
}
getSlugs();

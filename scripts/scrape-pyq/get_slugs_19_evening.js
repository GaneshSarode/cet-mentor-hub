...
async function getSlugs() {
  const url = 'https://questions.examside.com/past-years/year-wise/jee/mht-cet/mht-cet-2025-19th-april-evening-shift';
  ...
  const shiftPath = '/past-years/year-wise/jee/mht-cet/mht-cet-2025-19th-april-evening-shift/';
  ...
  fs.writeFileSync('slugs_19_evening.json', JSON.stringify(subjects, null, 2));
}
getSlugs();

...
async function seed() {
  ...
  const jsonPath = path.join(__dirname, '../scrape-pyq/pyq_mht_cet_2025_26_evening.json');
  ...
  try {
    ...
    const paperTitle = "MHT CET 2025 26th April Evening Shift";

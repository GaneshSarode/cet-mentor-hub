...
async function seed() {
  ...
  const jsonPath = path.join(__dirname, '../scrape-pyq/pyq_mht_cet_2024_4may_evening.json');
  ...
  try {
    ...
    const paperTitle = "MHT CET 2024 4th May Evening Shift";

...
async function seed() {
  ...
  const jsonPath = path.join(__dirname, '../scrape-pyq/pyq_mht_cet_2024_3may_morning.json');
  ...
  try {
    ...
    const paperTitle = "MHT CET 2024 3rd May Morning Shift";
